...
const SimplePostGeneratorPageAsync = () => {
  ...
  const pollJobStatus = async (jobId) => {
    try {
      ...
      setError('Fehler beim Überprüfen des Status')
      setLoading(false)
      setJobId(null)
      clearInterval(pollingInterval)
      setPollingInterval(null)
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        let errorMessage = data.error || 'Fehler beim Starten der Post-Generierung'
      ...
      setError('Verbindungsfehler beim Starten der Generierung')
      setLoading(false)
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-2">
            ...
            Social Media Post Generator (Async)
          </h1>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled={loading}
                />
                <p className="text-sm text-gray-500">Die Website, die Sie bewerben möchten</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled={loading}
                />
                <p className="text-sm text-gray-500">Das Hauptthema oder der Fokus Ihres Posts</p>
              </div>
              ...
              {generatedPost ? (
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold mb-2">Post-Inhalt:</h3>
                    <div className="whitespace-pre-wrap text-sm">{generatedPost.content}</div>
                  </div>
                  
                  {generatedPost.image_url && (
                    <div className="space-y-2">
                      <h3 className="font-semibold">Generiertes Bild:</h3>
                      <img 
...
export default SimplePostGeneratorPageAsync
